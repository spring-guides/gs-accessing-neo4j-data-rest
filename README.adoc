...
NOTE: Spring Data REST also supports link:/guides/gs/accessing-data-rest[Spring Data JPA], Spring Data Gemfire and link:/guides/gs/accessing-mongodb-data-rest[Spring Data MongoDB] as backend data stores, but those are not part of this guide.
...
Content-Length: 0
Date: Mon, 03 Mar 2014 17:28:03 GMT
```
