...
NOTE: Spring Data REST also supports link:/guides/gs/accessing-data-rest[Spring Data JPA], Spring Data Gemfire and Spring Data MongoDB as backend data stores, but those are not part of this guide.
